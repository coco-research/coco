# /SI-Decide — all-teams cross-team decision matrix (primary verb)
...
Decision matrix: options × personas(team) × verdict. Final recommendation + named dissent, explicitly flagging where one team's lens overrides another's.
