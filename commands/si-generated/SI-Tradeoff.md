# /SI-Tradeoff — all-teams side-by-side A-vs-B across teams
...
## Step 3 — Tradeoff output
Dimensions × options table; each row carries the team lens; aggregate verdict + most-opposed team named.
