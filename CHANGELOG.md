...
- **Corrected the asset counts in `.claude-plugin.json`,** which advertised 59 skills and 34 commands against a true 75 and 35, and understated the shipped system bundles as three rather than four.
