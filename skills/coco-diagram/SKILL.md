...
| **Consultant special** (quadrant only) | `example-quadrant-consultant.html` | strategy-consulting style 2×2 scenario matrix. Clinical sans-serif, white bg, bold blue double-ended axes, named scenario cells. See [type-quadrant.md](references/type-quadrant.md#consultant-special-2x2-scenario-matrix). |
