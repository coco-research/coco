...
Write `coco-ads-output/coco-ads-plan.md`. One focused page. This is the creative north star for the entire video.
...
Do not require exact SFX filenames in `coco-ads-plan.md` unless the user explicitly requested a specific sound or the mapping is unavoidable. Prefer moment types and intent.
