# Yann LeCun — Founding Memory v2 Panel Attribution
...
**Source:** `the founding memory-architecture plan`, line 753–757, v3.10 micro-phase.
...
**Cross-reference:** `the founding merged spec`, line 536, v2.3 deep-dive:
...
**Source:** `the founding memory-architecture plan`, line 598, Open questions list:
...
- **AAR Distillation Worker** — "Cell A + B unanimous biggest gap" (line 259/688). LeCun aligned with the "the product gets smarter the more I use it" framing as table stakes — consistent with his world-models position that memory + adaptation, not pure scale, is the missing piece.
...
Per `the founding merged spec` line 463–466, the v2.3 deep-dive includes the open-vocabulary entity extension as a confirmed deliverable, locking LeCun's P5 stance into the v3 plan.

## Suggested phrasing for convene synthesis

When `/superintelligenceTeam-convene` cites LeCun on the founding synthesis, prefer:
